This document describes the syntax and semantics of querying FHIR [Device](https://hl7.org/fhir/R4/device.html) resources via the standard FHIR RESTful API. A [Device](https://hl7.org/fhir/R4/device.html) resources represent individual Personal Health Devices (medical aids and implants) of a patient, such as glucometers, CGM sensors, and pace makers. 
