...
|Blood Pressure Value ([Observation](https://hl7.org/fhir/R4/observation.html))|[US Core Blood Pressure Profile](https://hl7.org/fhir/us/core/STU8.0.1/StructureDefinition-us-core-blood-pressure.html)| `Observation.device` is optional for US Core.
| | [US Vitals Blood Pressure Panel](http://hl7.org/fhir/us/vitals/StructureDefinition/blood-pressure-panel)| `Observation.device` is optional for US Vitals. |
