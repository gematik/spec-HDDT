...
| **Unique**              | The Pairing ID MUST be unique **at least within each HiMi system**. <br>If the same patient pairs with multiple DiGAs, each pairing MUST result in a distinct Pairing ID.                                                         |
