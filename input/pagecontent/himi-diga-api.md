...
| `valueQuantity`  | MUST | [Observation](https://hl7.org/fhir/R4/observation.html) | Search for observations based on their value.<br>[Link to search parameter list](https://hl7.org/fhir/R4/observation.html#search).|
| `component-code` | MUST\* | [Observation](https://hl7.org/fhir/R4/observation.html) | \* Only applies to MIV [_Blood Pressure Monitoring_](measurement-blood-pressure.html). Search for observations based on component codes.<br>[Link to search parameter list](https://hl7.org/fhir/R4/observation.html#search).|
| `component-value-quantity` | MUST\* | [Observation](https://hl7.org/fhir/R4/observation.html) | \* Only applies to MIV [_Blood Pressure Monitoring_](measurement-blood-pressure.html). Search for observations based on component values.<br>[Link to search parameter list](https://hl7.org/fhir/R4/observation.html#search).|
| `component-code-value-quantity` | SHOULD\* | [Observation](https://hl7.org/fhir/R4/observation.html) | \* Only applies to MIV [_Blood Pressure Monitoring_](measurement-blood-pressure.html). Search for observations based on both component code and value.<br>[Link to search parameter list](https://hl7.org/fhir/R4/observation.html#search).|
