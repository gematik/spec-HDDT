...
| **Returned Objects** | JSON object containing the claims: <br>&ensp;•  `access_token`<br>&ensp;•  `refresh_token`<br>&ensp;•  `token_type`<br>&ensp;•  `expires_in`<br> &ensp;• `scope`<br> &ensp;• `sub`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
