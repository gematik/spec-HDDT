...
The links between these resources are maintained within the _HiMi-SST-VZ_. Users of the registry can discover the Device Data Recorder's __FHIR Resource Server__ and __OAuth2 Authorization Server__ through the [BfArM Device Directory API](registries-and-zts.html#HiMi-SST-VZ). 
