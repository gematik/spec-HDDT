...
* ToDo: 
    * Anm. Andrea: Umbenennen in "introduction"?
    * Done: Einführung ggf. etwas weiter ausschmücken; Begriff HDDT einführen, Ergänzungen @jcaumann?
    * Done: Impressum ergänzen
    * Hinweis auf die Lizenz ergänzen, unter der die Spezifikation veröffentlicht wird
    * Hinweis ergänzen, dass das der erste Draft für die Validierung mit den Herstellern ist (Anm. Andrea: vllt machen wir anstatt "Standardisation plan" einen zweiten Punkt "Status and roadmap", worunter das dann genannt wird?)
