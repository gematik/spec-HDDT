...
used to initiate the Authorization Code Flow. It is the endpoint where the insured person (resource owner) is redirected
...
in [RFC 6749](https://www.rfc-editor.org/rfc/rfc6749). The URL below is a common convention. HiMi manufacturers MAY
