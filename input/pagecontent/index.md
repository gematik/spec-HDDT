...
* Device Properties and other attributes are encoded using vocabularies from DIN EN ISO/IEEE 11073. ISO publications and materials are protected by copyright and are subject to the user’s acceptance of ISO’s conditions of copyright. Any use, including reproduction requires our written permission. For more information contact copyright@iso.org.
