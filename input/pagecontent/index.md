...
* The sections [Information Model](information-model.html) and [Retrieving Data](retrieving-data.html) provide logical descriptions of the FHIR-based data model and the RESTful interactions. Technical specifications for these interactions are provided in the section [FHIR Resource Server](ddr-diga-api.html). 
