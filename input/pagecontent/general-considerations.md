...
| DIN EN ISO/IEEE 11073 | Configuration settings of Personal Health Devices SHOULD be encoded using DIN EN ISO/IEEE 11073 nomenclature. The HDDT information model considers the DIN EN ISO/IEEE 11073 domain models of the devices evaluated during the HDDT MVP phase.                                                                                                                                                                                                                                                                                    |
...
* how the Personal Health Gateway handles data from uncalibrated devices (e.g. whether this data is sent to the Health
  Record or not)
* whether the _Device Data Recorder_ allows the retroactive correction or invalidation of measured data, and whether it makes such corrected or invalidated data accessible to DiGA
