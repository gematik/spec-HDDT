...
- Trust attributes of the technical communication partners are provided by the BfArM via the [_DiGA Verzeichnis_](registries-and-zts.html#diga-verzeichnis) (BfArM DiGA Directory) and the [_HIIS-VZ_](registries-and-zts.html#HIIS-VZ) (BfArM Device Directory). Existing directory processes are reused.
