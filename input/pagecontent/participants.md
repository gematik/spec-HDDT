...
Every Personal Device that falls under the regulation of § 374a SGB V is registered with the __BfArM Device Registry__. Every data recording platform (Aggregation Manager together with its connected Health Record) that is a [HDDT certification relevant system](certification-relevant-system.html) is registered with the BfArM Device Registry, too.  
